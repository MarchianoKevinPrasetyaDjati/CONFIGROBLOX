...
# Extract dan timpa file yang sudah ada
unzip -o /sdcard/Download/config.zip -d /sdcard/ > /dev/null 2>&1 || err "Gagal extract zip!"
rm -f /sdcard/Download/config.zip
...
# Ganti baris shared_link_1 dengan PS link terbaru
...
# Simpan cookies ke file cookie.txt (format yang dibaca winter-rejoin)
